...
intentmos hacerlo de distintas maneras más no se logró.
Agradeceriamos una explicacion en profundidad de la funcion gotoxy (exactamente en como meter el 
el "personaje" en la matriz).
*/
